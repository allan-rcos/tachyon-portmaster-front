...
export class UnloadItemRequest implements flatbuffers.IUnpackableObject<UnloadItemRequestT> {
  ...
  static getRootAsUnloadItemRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: UnloadItemRequest,
  ): UnloadItemRequest {
    return (obj || new UnloadItemRequest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsUnloadItemRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: UnloadItemRequest,
  ): UnloadItemRequest {
  ...
  static createUnloadItemRequest(
  ...
  unpack(): UnloadItemRequestT {
    return new UnloadItemRequestT(this.containerId(), this.productId(), this.quantity());
  }
...
export class UnloadItemRequestT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return UnloadItemRequest.createUnloadItemRequest(
      builder,
      containerId,
      productId,
      this.quantity,
