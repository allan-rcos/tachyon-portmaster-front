/**
 * Conta do usuário autenticado — perfil e troca de senha. É o mesmo
 * sujeito de {@link "src/model/users" | users}, visto de dentro: aqui não há id na
 * URL, o backend resolve pelo cookie de sessão.
 *
