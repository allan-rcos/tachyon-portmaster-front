/**
 * Usuários administrados: listagem, criação, edição, remoção e reset de
 * senha.
 *
 ...
 */
export * from './user-create-page.vm';
export * from './user-edit-page.vm';
export * from './user-list-page.vm';
