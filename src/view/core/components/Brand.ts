...
export function Brand(props: BrandProps = {}): TemplateResult {
  return html`<span class=${styles.brand}>
    ...
    ${
      props.compact
        ? nothing
        : html`<span class=${styles.word}>Port<span class=${styles.lit}>Master</span></span>`
    }
  </span>`;
}
