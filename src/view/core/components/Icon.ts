...
//
//  Os fragmentos usam a tag `svg` do Lit, e não `html`: dentro de um `<svg>` o
//  parser precisa do namespace certo, senão os nós saem como HTML e não
//  desenham.
// ============================================================
...
export function Icon(props: IconProps): TemplateResult {
