...
(() => {
  ...
  try {
    (() => {
       ...
       */
      function IconButton({ size = 'md', label, className = '', children, ...rest }) {
  ...
  try {
    (() => {
       ...
       */
      function Dialog({ open = false, title, onClose, actions = null, children }) {
        if (!open) return null;
        return /*#__PURE__*/ React.createElement(
          'div',
          {
  ...
  try {
    (() => {
      ...
      function Input({ label, hint, error, icon = null, id, className = '', ...rest }) {
        const fieldId =
          id || (label ? `cir-${label.replace(/\s+/g, '-').toLowerCase()}` : undefined);
        const inputCls = [
          'cir-input',
          icon ? 'cir-input--has-icon' : '',
          error ? 'cir-input--invalid' : '',
          className,
        ]
          .filter(Boolean)
          .join(' ');
  ...
  try {
    (() => {
       ...
       */
      function Switch({ checked = false, onChange, label, disabled = false, id, ...rest }) {
        const toggle = () => {
  ...
  try {
    (() => {
       ...
       */
      function Avatar({ src, name = '', size = 'md', status, className = '', ...rest }) {
        const initials = name
          .split(/\s+/)
          .filter(Boolean)
          .slice(0, 2)
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: 'components/surfaces/Badge.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
       ...
       */
      function Card({ title, interactive = false, className = '', children, ...rest }) {
        const cls = ['cir-card', interactive ? 'cir-card--interactive' : '', className]
          .filter(Boolean)
          .join(' ');
        return /*#__PURE__*/ React.createElement(
          'div',
  ...
  try {
   ...
   ============================================================ */
      ...
      const { Button, IconButton, Input, Switch, Card, Badge, Avatar, Tabs, Dialog, Toast } = DS;
      ...
      /* ---------- Topbar ---------------------------------------- */
      function Topbar({ title, region, setRegion }) {
        useLucide();
        return /*#__PURE__*/ React.createElement(
          'header',
          {
      ...
      /* ---------- small pieces ---------------------------------- */
      function Stat({ icon, label, value, unit, delta, tone }) {
        return /*#__PURE__*/ React.createElement(
          'div',
          {
      ...
      function NodeRow({ node, onDeprovision }) {
        useLucide();
        return /*#__PURE__*/ React.createElement(
          'div',
          {
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement('span', null, 'CPU'),
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement('span', null, 'MEM'),
            /*#__PURE__*/ React.createElement(Meter, {
              value: node.mem,
              tone: 'teal',
            }),
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                nodes.map((n) =>
                  /*#__PURE__*/ React.createElement(NodeRow, {
                    key: n.id,
                    node: n,
                    onDeprovision: () => {},
                  }),
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  /*#__PURE__*/ React.createElement(
                    'div',
                    null,
                    /*#__PURE__*/ React.createElement('b', null, 'cir-prod-02'),
                    ' joined the pool',
                    /*#__PURE__*/ React.createElement('time', null, '2m'),
                  ),
                ),
                /*#__PURE__*/ React.createElement(
                  'li',
                  ...
                  /*#__PURE__*/ React.createElement(
                    'div',
                    null,
                    /*#__PURE__*/ React.createElement('b', null, 'fra-1'),
                    ' CPU above 90%',
                    /*#__PURE__*/ React.createElement('time', null, '14m'),
                  ),
                ),
                /*#__PURE__*/ React.createElement(
                  'li',
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    null,
                    'Volume ',
                    /*#__PURE__*/ React.createElement('b', null, 'vol-7a2'),
                    ' attached',
                    /*#__PURE__*/ React.createElement('time', null, '38m'),
                  ),
                ),
                /*#__PURE__*/ React.createElement(
                  'li',
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    null,
                    'Snapshot ',
                    /*#__PURE__*/ React.createElement('b', null, 'snap-19'),
                    ' created',
                    /*#__PURE__*/ React.createElement('time', null, '1h'),
                  ),
                ),
              ),
            ),
      ...
      function Nodes({ nodes, onProvision, onDeprovision }) {
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  'div',
                  null,
                  /*#__PURE__*/ React.createElement('b', null, 'Auto-scale pool'),
                  /*#__PURE__*/ React.createElement(
                    'span',
                    null,
                    'Add nodes when sustained load exceeds 80%.',
                  ),
                ),
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  'div',
                  null,
                  /*#__PURE__*/ React.createElement('b', null, 'Maintenance mode'),
                  /*#__PURE__*/ React.createElement(
                    'span',
                    null,
                    'Pause scheduling and drain new work.',
                  ),
                ),
                /*#__PURE__*/ React.createElement(Switch, {
                  checked: b,
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  'div',
                  null,
                  /*#__PURE__*/ React.createElement('b', null, 'Spend alerts'),
                  /*#__PURE__*/ React.createElement(
                    'span',
                    null,
                    'Email when monthly spend passes budget.',
                  ),
                ),
                /*#__PURE__*/ React.createElement(Switch, {
                  checked: c,
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              nav === 'settings' && /*#__PURE__*/ React.createElement(Settings, null),
              nav === 'network' &&
          ...
          /*#__PURE__*/ React.createElement(
            ...
            ' and detaches its volumes. This cannot be undone.',
          ),
          /*#__PURE__*/ React.createElement(
            'div',
            {
      ...
      ReactDOM.createRoot(document.getElementById('root')).render(
        /*#__PURE__*/ React.createElement(ConsoleApp, null),
      );
    })();
  } catch (e) {
    __ds_ns.__errors.push({
      path: 'ui_kits/console/console.jsx',
      error: String((e && e.message) || e),
    });
  }
