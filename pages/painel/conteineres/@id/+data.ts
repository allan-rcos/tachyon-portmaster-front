/**
 * Trabalho de servidor de `/painel/conteineres/@id`, resolvido ANTES do render.
 *
 ...
 */
import { createContainerDetailPageInput } from '@viewmodel/containers/container-detail-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createContainerDetailPageInput);
}
