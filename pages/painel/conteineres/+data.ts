/**
 * Trabalho de servidor de `/painel/conteineres`, resolvido ANTES do render.
 *
 ...
 */
import { createContainerListPageInput } from '@viewmodel/containers/container-list-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createContainerListPageInput);
}
