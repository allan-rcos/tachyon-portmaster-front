/**
 * Trabalho de servidor de `/painel`, resolvido ANTES do render.
 *
 ...
 */
import { createDashboardPageInput } from '@viewmodel/metrics/dashboard-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createDashboardPageInput);
}
