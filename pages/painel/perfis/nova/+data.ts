/**
 * Trabalho de servidor de `/painel/perfis/nova`, resolvido ANTES do render.
 *
 ...
 */
import { createRoleCreatePageInput } from '@viewmodel/roles/role-create-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createRoleCreatePageInput);
}
