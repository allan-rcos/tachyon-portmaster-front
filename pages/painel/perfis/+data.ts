/**
 * Trabalho de servidor de `/painel/perfis`, resolvido ANTES do render.
 *
 ...
 */
import { createRoleListPageInput } from '@viewmodel/roles/role-list-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createRoleListPageInput);
}
