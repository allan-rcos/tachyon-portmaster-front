/**
 * Trabalho de servidor de `/painel/perfis/@id/permissoes`, resolvido ANTES do render.
 *
 ...
 */
import { createRolePermissionsPageInput } from '@viewmodel/roles/role-permissions-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createRolePermissionsPageInput);
}
