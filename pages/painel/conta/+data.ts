/**
 * Trabalho de servidor de `/painel/conta`, resolvido ANTES do render.
 *
 ...
 */
import { createAccountPageInput } from '@viewmodel/account/account-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createAccountPageInput);
}
