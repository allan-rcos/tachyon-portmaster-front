/**
 * Trabalho de servidor de `/painel/produtos/@id/editar`, resolvido ANTES do render.
 *
 ...
 */
import { createProductEditPageInput } from '@viewmodel/products/product-edit-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createProductEditPageInput);
}
