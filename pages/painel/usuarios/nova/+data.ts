/**
 * Trabalho de servidor de `/painel/usuarios/nova`, resolvido ANTES do render.
 *
 ...
 */
import { createUserCreatePageInput } from '@viewmodel/users/user-create-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createUserCreatePageInput);
}
