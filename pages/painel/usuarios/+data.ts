/**
 * Trabalho de servidor de `/painel/usuarios`, resolvido ANTES do render.
 *
 ...
 */
import { createUserListPageInput } from '@viewmodel/users/user-list-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createUserListPageInput);
}
