/**
 * Trabalho de servidor de `/painel/usuarios/@id/editar`, resolvido ANTES do render.
 *
 ...
 */
import { createUserEditPageInput } from '@viewmodel/users/user-edit-page.vm';
...
async function data(pageContext: PageContext) {
  return toPageInput(pageContext, createUserEditPageInput);
}
