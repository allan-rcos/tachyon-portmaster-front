 ...
 * aqui que ela passa a viver.
 *
 * A diferença para a variante lit é um passo a menos: aqui não há `vike-lit`
 * para construir, só o adapter do txiki. O `vike-solid` vem instalado como
 * dependência normal.
 *
