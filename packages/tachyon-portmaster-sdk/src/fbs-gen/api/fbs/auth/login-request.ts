...
static createLoginRequest(builder:flatbuffers.Builder, emailOffset:flatbuffers.Offset, passwordOffset:flatbuffers.Offset):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LoginRequest.createLoginRequest(builder,
    email,
    password
  );
}
